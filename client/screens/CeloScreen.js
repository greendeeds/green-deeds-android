...
export default class CeloScreen extends React.Component {
  ...
  state = {
    ...
    exchangeRate: "",
    donateAmount: "1",
    redeemableAmount: this.props.route.params
      ? this.props.route.params.redeemableAmount
      : "0",
    withdrawAmount: this.props.route.params
      ? this.props.route.params.redeemableAmount
      : "0",
    ...
    return (
      <View style={styles.container}>
        ...
        {this.state.loggedIn === false ? (
          <>
            <Text>
              You must have Celo Wallet (alfajores network) installed!
            </Text>
          ...
          <ScrollView>
            ...
            <Text style={styles.title}>
              Withdraw {this.state.withdrawAmount} from Faucet
            </Text>
